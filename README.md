...
- Reduced API response times from 800ms to 400ms through query
  refactoring and indexing on high-traffic endpoints
- AWS KMS encryption, HMAC-SHA256 auth, RBAC, JWT refresh flows
- Infrastructure: EC2 (dev), ECS (sandbox/prod), Docker, GitHub
  Actions CI/CD
